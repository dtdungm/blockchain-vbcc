...
\begin{table}
\caption{Một số ví dụ loại sổ cái phân tán}
	\label{table:ex-dlt}
	\begin{tabularx} {\textwidth} {|X|X|X|p{5cm}|}
\hline
	Data Model   & Number of ledgers & Owner & Example \\ \hline
	Account   & 1 & Người quản trị & Traditional ledgers\\ \hline
	Tài sản   & Nhiều  &  Một nhóm & Private ledger\\ \hline
	Tiền và tải khoản   &  1 & Một người  & Crypto-currencies Bitcoin Ethereum \\ \hline
\end{tabularx}
\end{table}

Bảng \ref{table:ex-dlt} minh họa distribute ledger
