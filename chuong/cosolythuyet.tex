...
\hline
	...
	Hyperledger Farbic v1.x  & Docker & Go, Java & Khóa-Giá trị\\ \hline
...
BigchainDB là một nền tảng mã nguồn mở. Thiết kế của BigchainDB là một cơ sở dữ liệu và mang các tính chất của Blockchain.
...
\begin{itemize}
	\item Tùy biến mô hình dữ liệu tài sản
