...
Mạng Blockchain có thể được phân loại thành Blockchain công khai và Blockchain riêng tư \cite{8246573}. Loại thứ nhất gồm Bitcoin, Ethereum, ai cũng có thể tham gia và rời khỏi mạng Blockchain, mô hình này phân tán hoàn toàn, mỗi nút có vai trò ngang hàng nhau. Loại thứ hai gồm Hyperledger, BigchainDB,\ldots, việc tham gia mạng Blockchain được kiểm soát bằng cơ chế xác định danh tính của người tham gia.

\textbf{So sánh giữa các mạng Blockchain}

Mạng Blockchain được Tien Tuan Anh Dinh và cộng sự nghiên cứu \cite{8246573} dựa theo 4 khái niệm chính của Blockchain: sổ cái phân tán, cơ chế đồng thuận (concensus), mô hình mật mã, hợp đồng thông minh (smart contract),

\emph{Sổ cái phân tán}

Blockchain không dựa vào các tổ chức thứ ba để quản lý và xác thực và không có sự kiểm soát trung tâm.
Tất cả thông tin được các nút kiểm tra, truyền tải và quản lý đặt sự tin tưởng và các nút. 
Các nút có bảo sao lưu trữ các giao dịch trong một khối ghép nối với nhau thành chuỗi.
...
\textbf{Thuận toán đồng thuận}

\textbf{Mô hình mật mã}

\textbf{Hợp đồng thông minh}
