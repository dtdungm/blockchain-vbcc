...
\subsection{Mật mã khóa bí mật và mật mã khóa công khai}
...
\caption{Sơ đồ ký số và xác thực chữ ký số một thông điệp}
\label{fig:dig_sig}
\end{figure}
...
\item Tính không chối bỏ hay chống thoái thác trách nhiệm: vì chỉ có chủ thông điệp mới có khóa riêng để ký lên thông điệp nên người ký không thể chối bỏ thông điệp của mình
\end{enumerate}
...
\subsection{Dịch vụ chứng thực chữ ký số}
