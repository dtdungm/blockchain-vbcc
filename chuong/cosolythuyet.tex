...
\subsection{Giới thiệu}
Blockchain là cuốn sổ cái kỹ thuật số chống giả mạo được triển khai theo mô hình phân tán (không có kho lưu trữ trung tâm) và thường không cần một đơn vị đáng tin cậy chứng thực (như ngân hàng, công ty, chính phủ). 
...
Vào năm 2008, ý tưởng Blockchain được kết hợp với một số công nghệ máy tính và mạng internet để tạo ra đồng tiền mã hóa hiện đại: tiền điện tử được bảo vệ bởi các cơ chế mật mã học thay vì nhờ vào bên chứng thực hoặc kho lưu trữ trung tâm.

Công nghệ này được biết đến rộng rãi vào năm 2009 với sự ra đời của mạng Bitcoin\cite{nakamoto2008bitcoin}, một trong những đồng tiền mã hóa hiện đại đầu tiên.
