...
Thông tin VBCC được lưu trên blockchain có đặc tính chống sửa đổi và đảm bảo tính toàn vẹn dữ liệu.  
...
Đề tài đề xuất ứng dụng công nghệ Blockchain trong quản lý VBCC nhằm hỗ trợ theo dõi việc cập nhật thông tin cho người sử dụng, nhưng vẫn đảm bảo tính minh bạch, công khai và an toàn. Các mục tiêu cụ thể như sau:
